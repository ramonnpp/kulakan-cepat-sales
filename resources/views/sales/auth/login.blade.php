    ...
    <div class="flex min-h-screen w-full">
        ...
        <div class="w-full md:w-1/2 flex items-center justify-center p-4 sm:p-20">
            <form method="POST" action="" class="bg-white shadow-lg rounded-xl p-8 w-full max-w-md text-center">
                ...
                @if ($errors->any())
                    <div class="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 mb-4 text-left text-sm"
                        role="alert">
                ...
                <button type="submit"
                    class="w-full bg-[#B8182D] hover:bg-[#520B14] text-white py-2 rounded-md text-base font-medium transition">Login</button>
                ...
                <p class="mt-2 text-sm">
                    Belum punya akun?
                    <a href="" class="text-red-600 hover:underline font-bold">Daftar di sini</a>
                </p>
            </form>
        </div>
    </div>
