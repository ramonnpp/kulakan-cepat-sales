<aside id="sidebar"
    ...
    <div class="space-y-2">
        <a href="{{ '/sales' }}"
            ...
            <div
                class="p-2 rounded-lg {{ request()->routeIs('admin.dashboard') ? 'bg-white/10' : 'group-hover:bg-white/10' }} transition-all duration-300">
        ...
        <a href="{{ '/sales/customers' }}"
            class="group flex items-center px-3 py-3 text-sm font-medium rounded-xl transition-all duration-300 {{ request()->routeIs('sales.dashboard') ? 'bg-[#1d1b2e] text-white shadow-md' : 'text-gray-300 hover:bg-[#1d1b2e] hover:text-white' }}">
            <div
                class="p-2 rounded-lg {{ request()->routeIs('admin.dashboard') ? 'bg-white/10' : 'group-hover:bg-white/10' }} transition-all duration-300">
                <svg class="h-5 w-5 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
        ...
        <a href="{{ '/sales/leads' }}"
            ...
            <span class="ml-3 lg:hidden xl:inline">Add Customers</span>
        </a>
